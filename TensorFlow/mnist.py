...
if __name__ == "__main__":
    ...
    # os arquivos de numpy devem ser salvos em um arquivo para utilziar no modelo
    ...
    # localização que o modelo será salvo e o diretório 00000001 (precisa ser numerico)
